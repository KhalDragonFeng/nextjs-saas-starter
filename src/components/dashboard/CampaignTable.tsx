          ...
          {campaigns.map((campaign) => {
            ...
            return (
              ...
              >
                ...
                <td className="px-6 py-4">
                  <button className="rounded-lg bg-slate-800 p-1.5 text-slate-400 transition-all duration-200 hover:bg-slate-700 hover:text-slate-200" title="Go to Campaign AI Details">
