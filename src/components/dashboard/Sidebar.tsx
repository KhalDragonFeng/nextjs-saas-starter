    ...
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-64 flex-col border-r border-slate-700/50 bg-slate-900">
      ...
      <div className="border-t border-slate-700/50 p-4">
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-violet-500 text-sm font-semibold text-white">
            DU
          </div>
          <div className="min-w-0 flex-1">
            <p className="truncate text-sm font-medium text-slate-50">Demo User</p>
            <p className="truncate text-xs text-slate-500">demo@saas.com</p>
          </div>
          <button
            onClick={handleLogout}
            className="rounded-lg p-1.5 text-slate-400 transition-all duration-200 hover:bg-slate-800 hover:text-red-400"
            title="Logout"
          >
